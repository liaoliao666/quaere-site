...
Quaere 是一款服务端状态管理优先的状态管理库，同时也支持客户端状态管理。它的核心实现类似于 [Tanstack Query](https://github.com/tanstack/query) 和 [Jotai](https://github.com/pmndrs/jotai)，并提供了一套声明式的、原子化的状态管理方案，帮助你高效地管理服务端状态和客户端状态。无论是简单还是复杂的，Quaere 都可以胜任。
